...
class TopicForm extends React.Component {
	...
	constructor(props) {
		...
		this.state = {
			...
			inputMinLength: props.inputMinLength,
			inputLength: '',
			inputCharsRemaining: '',
		...
		this.domainFilter = props.domainFilter
	...
	handleSaveTap() {
		...
		this.props.addTopic(this.state.inputValue, this.domainFilter)
	}
	...
	render() {
		...
		return (
			<div>
				<h2>Create topic in category: {this.props.domainFilter}</h2>
